...
<body>
	...
	<div align="center">
		...
		<div id="event_reg_form">
			<form action="eventReg_proc.jsp" method="post" enctype="multipart/form-data">
				<table border="1" width="500px">
					<tr>
						<td><p>이벤트 명</p> <input type="text" name="EVENT_title"></td>
					</tr>
					<tr>
						<td><p>이벤트 시작 기간</p> <input type="text" name="start_term" id="StartDatePicker"></td>
					</tr>

					<tr>
						<td><p>이벤트 종료 기간</p> <input type="text" id="EndDatePicker" name="END_date"></td>
					</tr>
					<tr>
						<td><p>이벤트 이미지</p> <input type="file" name="event_content_img"></td>
					</tr>
